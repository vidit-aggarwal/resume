...
%----------------------------------------------------------------------------------------
\documentclass[a4paper, margin, centered]{res}
\topmargin=-0.5in
\oddsidemargin -.6in
\evensidemargin -.5in
\textwidth=6.5in
...
\begin{flushleft}\hfill \\
    \hspace{-\hoffset}
    \huge\bf{Vidit Aggarwal}
\end{flushleft}
\begin{flushleft}
\hspace{-\hoffset}
\textbf{Address for Correspondence:}\\\hspace{-\hoffset}
DIT University\\\hspace{-\hoffset}
Mussoorie-Diversion Road, Dehradun,\\\hspace{-\hoffset}
Uttarakhand-248009, India\\
\hfill\\\hspace{-\hoffset}
\textbf{Phone:} \(+91\) 9917617597, \(+91\) 8267941668\\\hspace{-\hoffset}
\textbf{E-Mail:} \href{mailto:vidit.a.aggarwal@gmail.com}{vidit.a.aggarwal@gmail.com} \hfill \\ \ 
\end{flushleft}
\vspace{-6mm}
\begin{center}
